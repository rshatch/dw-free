...
my $accesslists = DW::Controller::API::REST->path('journals/accesslists.yaml', 1, { get => \&accesslist_get, post => \&accesslist_edit});
...
my $tags = DW::Controller::API::REST->path('journals/tags.yaml', 1, { get => \&tags_get, post => \&tags_post, delete => \&tags_delete});
...
my $xpost = DW::Controller::API::REST->path('journals/xpostaccounts.yaml', 1, { get => \&xpost_get});
